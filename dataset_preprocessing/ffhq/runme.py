...
# Align wilds
cmd = "python align_multiprocess.py --source=E:\data\FFHQ\imgs1024\in-the-wild-images --dest=E:\data\FFHQ/ed3g/realign1500 --threads=10"
subprocess.run([cmd], shell=True, check=True)

# #--------------------------------------------------------------------------------------------------------#

# Move out of subdirs into single directory
realign1500_dir = 'E:\data\FFHQ/ed3g/realign1500'
...
input_flag = " --indir " + 'E:\data\FFHQ/ed3g/realign1500'
output_flag = " --outdir " + 'E:\data\FFHQ\ed3g/eg3d_final_crops'
