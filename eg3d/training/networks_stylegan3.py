...
class MappingNetwork(torch.nn.Module):
    def __init__(self,
        ...
        num_ws,                     # Number of intermediate latents to out.
...
class SynthesisInput(torch.nn.Module):
    def __init__(self,
        w_dim,          # Intermediate latent (W) dimensionality.
        channels,       # Number of out channels.
...
class SynthesisLayer(torch.nn.Module):
    def __init__(self,
        ...
        conv_clamp          = 256,      # Clamp the out to [-X, +X], None = disable clamping.
        ...
        # Compute padding.
        pad_total = (self.out_size - 1) * self.down_factor + 1 # Desired out size before downsampling.
...
class SynthesisNetwork(torch.nn.Module):
    def __init__(self,
        ...
        output_scale        = 0.25,     # Scale factor for the out image.
